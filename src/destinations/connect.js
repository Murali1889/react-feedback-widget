...
import { linearIssue, githubIssue, githubAction, notionDb, hubspot, slack } from './adapters/issue-trackers.js';
...
export const connect = {
  ...
  /** GitHub Issues. Server env: GITHUB_TOKEN (or GH_TOKEN), GITHUB_REPO (or GH_REPO). */
  github: githubIssue,
